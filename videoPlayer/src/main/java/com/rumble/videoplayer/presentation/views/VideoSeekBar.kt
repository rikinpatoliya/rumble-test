...
import com.rumble.videoplayer.presentation.internal.views.BufferingView
import com.rumble.videoplayer.presentation.internal.views.DisabledVideoSeekBar
        ...
        if (enableSeek) {
            Slider(
                ...
                colors = SliderDefaults.colors(
                    disabledActiveTrackColor = rumbleGreen,
                    disabledInactiveTrackColor = enforcedWhite.copy(0.6f),
                ),
                thumb = {
                    Icon(
            ...
            Slider(
                ...
                colors = SliderDefaults.colors(
                    thumbColor = enforcedWhite,
                    activeTrackColor = enforcedWhite,
