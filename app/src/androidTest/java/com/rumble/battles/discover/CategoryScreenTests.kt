...
class CategoryScreenTests {
    ...
    @Before
    fun setup() {
        every { mockHandler.state } returns MutableStateFlow(CategoryState(displayType = CategoryDisplayType.LIVE_STREAM))
    ...
    fun testScreenId() {
        ...
        composeRule.onNodeWithTag(CategoryTag).assertIsDisplayed()
    }
}